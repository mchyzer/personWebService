...
/*
 * @author mchyzer
 * $Id: PwsHibUtilsMapping.java,v 1.1 2013/06/20 06:02:50 mchyzer Exp $
 */
 ...
 */
public class PwsHibUtilsMapping {
...
//    entityEntry.isExistsInDatabase()
    ...
    if (object instanceof PersonWsHibernateBeanBase) {
      return ((PersonWsHibernateBeanBase)object).getVersionNumber() < 0;
    }
    ...
    throw new RuntimeException("Cant tell if insert if assigned key! " 
        + PersonWsServerUtils.className(object) + ", " + generator);
  }
  ...
  public static Property primaryKeyProperty(Class clazz) {
    clazz = PersonWsServerUtils.unenhanceClass(clazz);
    Configuration configuration = PersonWsDaoFactory.getFactory().getConfiguration();
  ...
  public static Serializable primaryKeyCurrentValue(Object object) {
    ...
    Serializable value = (Serializable)PersonWsServerUtils.propertyValue(object, propertyName);
    return value;
  }
