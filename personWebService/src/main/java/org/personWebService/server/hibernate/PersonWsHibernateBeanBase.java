...
import org.personWebService.server.util.PwsCloneable;
 ...
 * Base Hib API class.
 * <p/>
 * @version $Id: PersonWsHibernateBeanBase.java,v 1.1 2013/06/20 06:02:50 mchyzer Exp $
 */
@SuppressWarnings("serial")
public abstract class PersonWsHibernateBeanBase implements PwsCloneable, Serializable, HibPwsLifecycle, Lifecycle {

  /**
   * delete this record from the database
   * @param twoFactorDaoFactory
   */
  public abstract void delete(final PersonWsDaoFactory twoFactorDaoFactory);
   ...
   * @param cloneTo
   */
  protected void cloneHelper(PersonWsHibernateBeanBase cloneTo) {
  ...
  public Object fieldValue(String fieldName) {
    ...
    return PersonWsServerUtils.fieldValue(null, this, fieldName, true, true, false);
  }
  ...
  /**
   * @see HibPwsLifecycle#onPostDelete(HibernateSession)
   */
  @Override
  ...
  /**
   * @see HibPwsLifecycle#onPostSave(HibernateSession)
   */
  @Override
  ...
  /**
   * @see HibPwsLifecycle#onPostUpdate(HibernateSession)
   */
  @Override
  ...
  /**
   * @see HibPwsLifecycle#onPreDelete(HibernateSession)
   */
  @Override
  ...
  public void onPreSave(HibernateSession hibernateSession) {
    ...
    if (PersonWsServerUtils.equals(INITIAL_VERSION_NUMBER, this.versionNumber)
        && PersonWsServerUtils.isBlank(this.uuid)) {
      this.uuid = PersonWsServerUtils.uuid();
    }
  }


  /**
   * @see HibPwsLifecycle#onPreUpdate(HibernateSession)
   */
   ...
   */
  @Override
  public abstract PersonWsHibernateBeanBase clone();
