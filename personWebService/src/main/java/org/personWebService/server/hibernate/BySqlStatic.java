...
public class BySqlStatic {
  ...
  private static final Log LOG = PersonWsServerUtils.getLog(BySqlStatic.class);
  ...
  public int executeSql(final String sql, final List<Object> params) {
    ...
    int result = (Integer)HibernateSession.callbackHibernateSession(
        PersonWsTransactionType.READ_WRITE_OR_USE_EXISTING, PwsAuditControl.WILL_NOT_AUDIT, new HibernateHandler() {
      ...
      public Object callback(HibernateHandlerBean hibernateHandlerBean)
        ...
        try {
          ...
          if (PwsDatabasePerfLog.LOG.isDebugEnabled()) {
            PwsDatabasePerfLog.dbPerfLog(((System.nanoTime()-start)/1000000L) + "ms SQL: " + sql + ", params: " + PersonWsServerUtils.toStringForLog(params) + ", result: " + result1);
          }
    ...
    List<T> theResult = (List<T>)HibernateSession.callbackHibernateSession(
      ...
      public Object callback(HibernateHandlerBean hibernateHandlerBean)
        ...
        try {
          ...
          PersonWsServerUtils.closeQuietly(preparedStatement);
          if (PwsDatabasePerfLog.LOG.isDebugEnabled()) {
            PwsDatabasePerfLog.dbPerfLog(((System.nanoTime()-start)/1000000L) + "ms SQL: " + sql + ", params: " + PersonWsServerUtils.toStringForLog(params) + ", rows: " + PersonWsServerUtils.length(resultList));
          }
        }
      }
    });
  ...
  public static void attachParams(PreparedStatement statement, Object params)
    ...
    List<Object> paramList = PersonWsServerUtils.toList(params);
    List<Type> typeList = PwsHibUtils.hibernateTypes(paramList);
  ...
  public static void attachParams(PreparedStatement statement, Object params, Object types)
    ...
    List paramList = PersonWsServerUtils.toList(params);
    List typeList = PersonWsServerUtils.toList(types);
