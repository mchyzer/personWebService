/*
 * @author mchyzer
 * $Id: PwsQueryPaging.java,v 1.1 2013/06/20 06:02:50 mchyzer Exp $
 */
...
public class PwsQueryPaging {
  ...
  public void assertInitted() {
    if (!this.initted()) {
      throw new RuntimeException(
          "PwsQueryPaging bean needs to be initted and calculated! " + this);
    }
  }
   ...
   */
  public static PwsQueryPaging page(int pageSize, int pageNumber, boolean doTotalCount) {
    if (pageSize == -1 && pageNumber <= 0) {
      return null;
    }
    return new PwsQueryPaging(pageSize, pageNumber, doTotalCount);
  }
   ...
   */
  public PwsQueryPaging(int pageSize1, int pageNumber1, boolean doTotalCount1) {
