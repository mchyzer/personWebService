/**
 * @author mchyzer
 * $Id: PersonWsDaemonLog.java,v 1.1 2013/06/20 06:02:51 mchyzer Exp $
 */
...
public class PersonWsDaemonLog extends PersonWsHibernateBeanBase {
   ...
   * default some fields
   */
  public PersonWsDaemonLog() {
    this.processId = ManagementFactory.getRuntimeMXBean().getName();
    this.serverName = PersonWsServerUtils.hostname();
  }
  
  /**
   * status of daemon: PersonWsDaemonLogStatus e.g. success, error
   */
  ...
  /**
   * @see org.personWebService.server.hibernate.PersonWsHibernateBeanBase#clone()
   */
  @Override
  public PersonWsHibernateBeanBase clone() {
    return PersonWsServerUtils.clone(this, CLONE_FIELDS);
  }

  /**
   * @see org.personWebService.server.hibernate.PersonWsHibernateBeanBase#dbNeedsUpdate()
   */
  @Override
  public boolean dbNeedsUpdate() {
    PersonWsDaemonLog personWsDaemonLog = (PersonWsDaemonLog)this.dbVersion();
    
    return PersonWsServerUtils.dbVersionDifferent(personWsDaemonLog, this, DB_VERSION_FIELDS);
  }

  /**
   * @see org.personWebService.server.hibernate.PersonWsHibernateBeanBase#dbNeedsUpdateFields()
   */
  @Override
   ...
   */
  public void store(PersonWsDaoFactory twoFactorDaoFactory) {
   ...
   */
  @Override
  public void delete(final PersonWsDaoFactory twoFactorDaoFactory) {
