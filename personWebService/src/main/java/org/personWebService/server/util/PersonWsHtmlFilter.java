 ...
 */
public class PersonWsHtmlFilter implements PwsHtmlFilter {
  ...
  private static final Log LOG = PersonWsServerUtils.getLog(PersonWsHtmlFilter.class);
  ...
  /**
   * @see PwsHtmlFilter#filterHtml(String)
   */
  @Override
